                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select id="fixedp_start_time" name="fixedp_start_time" class="form-control" id="at" required="">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select id="fixedp_end_time" name="fixedp_end_time" class="form-control" id="bt" required="">
                                            <option value="" disabled="" selected="">Select Timeslot</option>
