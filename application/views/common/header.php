            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php print site_url('FleetManagement'); ?>"><i class="fa fa-circle-o"></i> Fleet Management</a></li>
                        <?php /*<li><a href="<?php print site_url('CancellationPolicy'); ?>"><i class="fa fa-circle-o"></i> Cancellation Policy</a></li> */ ?>
                    </ul>
                </li>
