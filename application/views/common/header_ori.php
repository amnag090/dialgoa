                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown notifications-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <i class="fa fa-user fa-fw" style="color: #d9534f;"></i>
                                    <span style="color: #444;"><?php print $this->session->userdata('admin')->name; ?> (<?php print $this->session->userdata('admin')->role; ?> ) </span>
                                    <i class="fa fa-caret-down" style="color: #d9534f;"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-user">
                                   <?php /* <li><a href="<?php print site_url('admins/profile'); ?>"><i class="fa fa-key fa-fw" style="color: #d9534f;"></i> Change Password</a>
                                </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active"><a href="<?php print site_url('home'); ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php print site_url('vendor/approval'); ?>"><i class="fa fa-circle-o"></i> Vendol Approval</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?php print site_url('fixedpoints'); ?>"><i class="fa fa-circle-o"></i> Manage Fixed Point</a></li>
                        <li class="active"><a href="<?php print site_url('FixedPointFare'); ?>"><i class="fa fa-circle-o"></i> Manage Fixed Point Fare</a></li>
                        <li><a href="<?php print site_url('CancellationPolicy'); ?>"><i class="fa fa-circle-o"></i> Cancellation Policy</a></li>
                    </ul>
                </li>
