                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <label>Primary Contact no</label>
                                            <input class="form-control" placeholder="Primary Contact no" name="reg_primary_num" type="text" pattern="[0-9]+" oninvalid="setCustomValidity('Please enter a valid number (Numbers only)')" onchange="try{setCustomValidity('')}catch(e){}" autofocus required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Secondary Contact no</label>
                                                <input class="form-control" placeholder="Secondary Contact no" name="reg_secondary_num" type="text" pattern="[0-9]+" oninvalid="setCustomValidity('Please enter a valid number (Numbers only)')" onchange="try{setCustomValidity('')}catch(e){}" autofocus required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
